...
import { createSandboxTool } from '@orkestrel/mcp'
import type { SandboxToolInterface } from '@orkestrel/mcp'
...
describe('SandboxTool', () => {
	...
	describe('has', () => {
		it('returns true for existing file', async () => {
			...
			await t.execute({ operation: 'write', id, path: 'exists.txt', content: '' })
